...
from models import initialize_systems, cleanup_local_llm, ModelManager, systems_status
from routes import app # Import the app object from routes.py
...
if __name__ == '__main__':
    ...
    # Run the Flask app
    # The 'app' object is imported from routes.py where it's initialized
